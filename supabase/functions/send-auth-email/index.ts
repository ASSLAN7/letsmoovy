    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse;">
          ...
          <tr>
            <td align="center" style="padding: 40px; background: linear-gradient(135deg, ${brandColors.background} 0%, #1a2027 50%, ${brandColors.background} 100%); border-radius: 16px 16px 0 0; border-bottom: 2px solid ${brandColors.primary};">
              <div style="display: inline-block; position: relative;">
                <span style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 42px; font-weight: 800; background: linear-gradient(135deg, ${brandColors.accent} 0%, ${brandColors.primary} 50%, ${brandColors.primaryDark} 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: 4px; text-shadow: 0 0 40px rgba(20, 184, 166, 0.3);">MOOVY</span>
              </div>
