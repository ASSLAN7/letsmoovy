...
const getMoovyHeader = () => `
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, ${brandColors.background} 0%, #1a2027 50%, ${brandColors.background} 100%); border-radius: 16px 16px 0 0; padding: 32px; border-bottom: 2px solid ${brandColors.primary};">
    <tr>
      <td align="center">
