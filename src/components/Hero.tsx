...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroCar} alt="Modern electric car" className="w-full h-full object-cover opacity-60" />
      ...
      <div className="container relative z-10 px-6 pt-20">
        ...
        ease: "easeOut"
          ...
          delay: 0.2
            ...
            <span className="text-sm text-muted-foreground">100% Flexibility </span>
          </motion.div>
